...
@RequestMapping("mvc")
@Controller
public class SpringMvcComtroller {
	private static final Logger logger = LoggerFactory.getLogger(SpringMvcComtroller.class);
	...
	*/
	...
	public String redirect(String userId, Model model, HttpSession session,
		...
		//redirect시 최초 1회에 한해 해당 속성값을 유지하고, 읽혀지면 자동으로 세션에서 해당 속성을 제거한다
