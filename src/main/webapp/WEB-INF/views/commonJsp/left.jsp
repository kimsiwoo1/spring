...
<ul class="nav nav-sidebar">
	...
	<li class="active"><a href="${cp }/lprod/lprodList">제품그룹리스트 <span class="sr-only">(current)</span></a></li>
	<li class="active"><a href="${cp }/lprod/lprodPagingList">제품그룹 페이징 리스트 <span class="sr-only">(current)</span></a></li>
</ul>